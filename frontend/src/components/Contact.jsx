        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              <div>
                <label htmlFor='name' className='block text-[var(--primary)] font-medium mb-2'>
                  Name
                </label>
                <input
                  type='text'
              ...
              <div>
                <label htmlFor='email' className='block text-[var(--primary)] font-medium mb-2'>
                  Email
                </label>
                <input
                  type='email'
              ...
              <div>
                <label htmlFor='message' className='block text-[var(--primary)] font-medium mb-2'>
                  Message
                </label>
                <textarea
                  id='message'
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type='submit'
                className='w-full bg-[var(--accent)] text-white px-6 py-3 rounded-lg hover:bg-[var(--hover-accent)] transition-colors duration-300 shadow-md'
              >
                Send Message
              </motion.button>
            </form>
          ...
          >
            <div className='bg-white p-8 rounded-xl shadow-lg'>
              ...
              <ul className='space-y-6'>
                <li className='flex items-center space-x-4'>
                  ...
                  <span className='text-[var(--primary)] opacity-80'>08022871344</span>
                </li>
                <li className='flex items-center space-x-4'>
                  <FaEnvelope className='text-[var(--accent)] text-xl' />
                  <a href='mailto:marvellousabiola08@gmail.com' className='text-[var(--primary)] opacity-80 hover:text-[var(--accent)] transition-colors duration-300'>
                    marvellousabiola08@gmail.com
                  </a>
                </li>
                <li className='flex items-center space-x-4'>
                  <FaMapMarkerAlt className='text-[var(--accent)] text-xl' />
                  <span className='text-[var(--primary)] opacity-80'>Lagos, Nigeria</span>
                </li>
              </ul>
            </div>
            ...
            {/* Newsletter Signup */}
            <div className='bg-white p-8 rounded-xl shadow-lg'>
              <h2 className='text-2xl font-semibold text-[var(--primary)] mb-6'>Stay Updated</h2>
              <p className='text-[var(--primary)] opacity-80 mb-6'>
