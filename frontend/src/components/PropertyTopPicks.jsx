      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          <h2 className='text-4xl md:text-5xl font-bold text-[var(--primary)] mb-4'>
            Top Picks for the Modern Traveller
          </h2>
          <p className='text-[var(--primary)] max-w-2xl mx-auto text-lg opacity-80'>
            Discover exceptional properties perfect for modern lifestyles and travel needs.
          </p>
        </motion.div>
            ...
            >
              <div className='relative'>
                ...
                <div className='absolute top-3 right-3 bg-white/90 rounded-full p-2 shadow-md'>
                  <span className='text-sm font-semibold text-[var(--accent)]'>Top Pick</span>
                </div>
              </div>
              <div className='p-4'>
...
export default PropertyTopPicks;